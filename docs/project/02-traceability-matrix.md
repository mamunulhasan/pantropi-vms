...
| US-01.2.2 | ENABLER — NFR-MNT-01, CON-01, CON-02 (SRS B1) | T-01.2.2.1/2/3 | `vms-architecture-tests` (13 ArchUnit rules), `.github/workflows/architecture-fitness.yml` | 13/13 rules pass; AC-4 violation injected → build failed naming class → removed → green; check required on both branches | #31 | pending | 0.1.0 |
