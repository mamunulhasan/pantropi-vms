...
-- =====================================================================
-- 14. Seed data - baseline roles, permissions & reference master data
-- =====================================================================
...
INSERT INTO vms.permissions (code, description) VALUES
    ...
    ('credential.override','Perform manual credential override'),
...
INSERT INTO vms.system_settings (key, value, description) VALUES
    ...
    ('notification.whatsapp.enabled', 'false',                'WhatsApp disabled until Business API approval'),
